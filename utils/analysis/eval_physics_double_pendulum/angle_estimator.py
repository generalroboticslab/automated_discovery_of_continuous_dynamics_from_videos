...
def obtain_angle(img):
    ...
    if rej_1:
        ...
        text = str((round(angle_1*180/np.pi)+ 180) % 360 - 180) + ' ' + str((round(angle_2*180/np.pi)+ 180) % 360 - 180)
        cv2.putText(img_marked, text, (10, 25), cv2.FONT_HERSHEY_DUPLEX, 0.8, (0, 0, 0), 2)
